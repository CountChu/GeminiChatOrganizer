...
def cmd_parse(args: argparse.Namespace) -> int:
    ...
    render_stats = render_all(state.processed_dir, state.turns_md_dir, state.template_path)
...
def cmd_render(args: argparse.Namespace) -> int:
    state = _state_from_args(args)
    stats = render_all(state.processed_dir, state.turns_md_dir, state.template_path)
